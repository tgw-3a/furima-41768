class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :price, format: { with: /\A[0-9]+\z/, message: 'is invalid. Input numericality characters.' },
                      numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_999_999, message: 'is invalid' }
